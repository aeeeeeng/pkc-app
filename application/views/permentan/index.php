        ...
        function table_permentan_f() {
            table_permentan = $("#table_permentan").DataTable({
                ...
                columns: [
                    ...
                    { data: 'permentan_total_urea', name: 'permentan_total_urea'},
                    { data: 'permentan_total_npk', name: 'permentan_total_npk'},
                    { data: 'permentan_total_organik', name: 'permentan_total_organik'},
