...
<section class="content">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Laporan Kinerja Bulanan</h3>
        </div>
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered table-pkc" id="table_laporan_kinerja_bulanan">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Tahun</th>
...
<script>
    ...
    function create() {
        $.ajax({
            ...
            success: function(response) {
                bootbox.dialog({
                    title: 'Buat Laporan Kinerja Bulanan',
                    message: response
                });
            }
        });
    ...
    function store() {
        ...
        $.ajax({
            url: '<?= base_url('api/laporan_kinerja_bulanan/store') ?>',
            type: 'POST',
            data: formData,
